...
import com.namekartapp.namekartappapi.AuctionList;
        ...
        import com.namekartapp.namekartappapi.namecheap.list.NamecheapListWebSocketHandler;
...
@RestController
@RequestMapping("/auctions/namecheap/all")
public class NamecheapListController {
...
//        ProgramHelper.doAllSendingAndDatabaseAddingTask("namecheaplist","live_list","list",message);
