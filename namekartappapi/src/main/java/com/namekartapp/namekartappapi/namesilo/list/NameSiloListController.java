...
@RestController
@RequestMapping("/auctions/namesilo/all")
public class NameSiloListController {
...
//        ProgramHelper.doAllSendingAndDatabaseAddingTask("namesilolist","live_list","list",message);
